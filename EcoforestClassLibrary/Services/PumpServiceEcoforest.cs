...
namespace EcoforestClassLibrary.Services
{
    internal class PumpServiceEcoforest : PumpService
    {
        ...
        public PumpServiceEcoforest(string excelFilePath)
        {
        ...
        public List<StandartPump> GetDataInListStandartPumpsForLuftEcoforest(List<StandartPump> standartPumps, List<Pump> oldPumps, int[] outTemps, int[] flowTemps, int forTemp, string climat)
        {
        ...
        public List<StandartPump> GetDataInListStandartPumpsEcoforest(List<StandartPump> standartPumps, List<Pump> oldPumps, int[] outTemps, int[] flowTemps, int forTemp, string climat, string typeFile)
        {
            foreach (var oldPump in oldPumps)
            {
                //Get the pump data dictionary
